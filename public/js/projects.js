...
(function(){
    ...
    description = "Business Modèle est un site web contenant des articles d'étude de développement des grande entreprises.<br /><br />La structure du projet repose sur un modèle MVC performant assurant une maintenance du code plus rapide.<br /><br />Logo produit par Marie-Anne Amélie sous Illustrator.";
    ...
    description = "Escape JUFAC est un projet universitaire dont le but était de développer un jeu vidéo dit \"Escape Game\". <br /><br />J'ai donc fait parti de l'équipe de développemetn du jeu vidéo 2D en tant que développeur Java ainsi que graphiste pour certaines parties du jeu.<br /><br />Le jeu vidéo a été développé sous éclipse en JAVA Swing reposant sur une forge utilisée via Git.";
    languages = ["JAVA"];
