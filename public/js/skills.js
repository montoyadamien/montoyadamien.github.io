...
(function(){
    ...
    skills = ["Java - Java Android", "PHP", "JavaScript - jQuery - Angular", "HTML - CSS - Bootstrap", "MySQL - PostgreSQL - PL/SQL", "C", "Python", "Bash", "IntelliJ - Visual Studio - Eclipse", "Unity", "Git", "Photoshop", "Suite office", "Windows - Linux - Mac OS X"];
    buildSkill();
